...
export default function About() {
  return (
    <main className="px-10 md:lg:px-[3.75rem] xl:px-20 bg-csrcyellow">
      <section className="relative flex flex-col justify-center items-center gap-4 h-[325px] md:h-[520px] xs:px-5 sm:px-10 md:lg:px-[3.75rem] xl:px-20 min-h-[520px]">
        <div className="flex flex-col items-center justify-center after:absolute after:bottom-1 after:md:bottom-[30px] after:bg-bubble_small after:w-[335px] after:h-[480px] after:md:bg-bubble_main after:bg-cover after:bg-no-repeat after:md:w-[760px] after:md:h-[414px]">
          <h1 className="text-csrcblue text-center font-bold text-3xl md:text-5xl md:max-w-[590px] md:pb-6 z-10">
            About
          </h1>
          <p className="max-w-[590px] z-10 break-words">
