...
export default async function FeatureProduct() {
  return (
    <section className="bg-product_highlight before:from-csrcblue before:via-csrcblue before:to-csrclight/0 xs:px-5 relative z-10 flex h-81.25 flex-col justify-center gap-6 bg-cover bg-center bg-no-repeat before:absolute before:top-0 before:right-0 before:bottom-0 before:left-0 before:-z-10 before:h-81.25 before:bg-linear-to-r before:from-35% before:via-70% before:to-95% sm:px-10 md:h-130 md:before:h-130 md:before:w-130 md:lg:px-15 xl:px-20">
